...
namespace ChaosCMS.Razor.Extensions
{
    public static class ParsingExtensions
    {
		...
		public static string ParseString<T>(this IChaosRazorEngine engine, string content, T model)
		{
		...
		/// <returns></returns>
		public static string ParseString(this IChaosRazorEngine engine, string content, object model, Type modelType)
		{
