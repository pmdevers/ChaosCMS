...
{
	public class ChaosRazorHost : RazorEngineHost
	{
		#region "Fields"

		private const string BaseType = "ChaosCMS.Razor.TemplatePage";
		private const string HtmlHelperPropertyName = "Html";

		private string _defaultModel = "dynamic";
		private string _defaultClassName = "__ChaosRazorTemplate";
		private string _defaultNamespace = "ChaosRazor.GeneratedTemplates";
		...
		/// </summary>
		public ChaosRazorHost(IFileProvider viewsFileProvider) : base(new CSharpRazorCodeLanguage())
		{
		...
		{
			get { return "ChaosCMS.Razor.Host.Internal.RazorInjectAttribute"; }
		}
		...
		public override ParserBase DecorateCodeParser(ParserBase incomingCodeParser)
		{
			...
			return new ChaosRazorCodeParser();
		}

        public override RazorChunkGenerator DecorateChunkGenerator(RazorChunkGenerator incomingChunkGenerator)
        {
			...
			CodeGeneratorContext context)
		{
			...
			return new ChaosRazorCSharpCodeGenerator(
				context,
				DefaultModel,
				InjectAttribute);
		}
