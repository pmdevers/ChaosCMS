...
namespace ChaosCMS.Razor.Host.Directives
{
	/// <summary>
	...
	{
		private readonly ChaosRazorHost _razorHost;
		...
		/// </summary>
		/// <param name="razorHost">The <see cref="ChaosRazorHost"/> used to parse <c>_ViewImports</c> pages.</param>
