...
{
	public class ChaosRazorCSharpCodeGenerator : CSharpCodeGenerator
	{
		private readonly string _defaultModel;
		private readonly string _injectAttribute;

		public ChaosRazorCSharpCodeGenerator(
			...
			CodeGeneratorContext context)
		{
			...
			return new ChaosRazorCSharpDesignTimeCodeVisitor(csharpCodeVisitor, writer, context);
		}
